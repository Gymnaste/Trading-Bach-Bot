...
import { Shield, Zap, TrendingUp, Globe, Lock, Cpu, ArrowRight, ChevronRight, Menu, X } from 'lucide-react';
    ...
    <div className="min-h-screen relative text-white font-sans selection:bg-cyan-400/30 overflow-x-hidden" style={{ backgroundColor: '#0A0E1A' }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-10">
            {['FONCTIONNALITÉS', 'PERFORMANCE', 'SÉCURITÉ', 'TARIFS'].map((item) => (
              <a 
                key={`nav-link-${item}`} 
          ...
          <div className="flex items-center gap-4">
            <button className="hidden sm:block text-sm font-bold tracking-[0.1em] text-cyan-400 hover:text-cyan-300 transition-colors uppercase">
              CONNEXION
            </button>
            <button className="px-6 py-2.5 rounded-full bg-cyan-400 text-[#0A0E1A] text-sm font-bold tracking-[0.1em] hover:bg-cyan-300 transition-all shadow-[0_0_20px_rgba(34,211,238,0.3)] hover:shadow-[0_0_30px_rgba(34,211,238,0.5)] uppercase">
              S'INSCRIRE
            </button>
          </div>
        </div>
      ...
      <section className="relative pt-40 pb-20 px-6">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          >
            <button className="px-10 py-5 rounded-2xl bg-cyan-400 text-[#0A0E1A] font-black tracking-[0.1em] hover:bg-cyan-300 transition-all flex items-center justify-center gap-3 uppercase group">
              COMMENCER MAINTENANT
              <ArrowRight className="group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="px-10 py-5 rounded-2xl bg-white/5 border border-white/10 font-black tracking-[0.1em] hover:bg-white/10 transition-all flex items-center justify-center gap-3 uppercase">
              DÉCOUVRIR L'IA
            </button>
          </motion.div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="px-12 py-6 rounded-2xl bg-white text-[#0A0E1A] font-black tracking-[0.2em] text-xl shadow-[0_0_50px_rgba(255,255,255,0.2)] uppercase hover:shadow-[0_0_80px_rgba(255,255,255,0.3)] transition-all"
          >
